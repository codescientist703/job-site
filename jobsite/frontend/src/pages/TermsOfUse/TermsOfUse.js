			...
			<Container>
				...
				<Content generalPage={true}>
					...
					<p>
						...
						Job Dundho uses ‘cookies’. These cookies are used to store
					...
					<p>
						...
						Notice to the Company should be sent to: Gujarat, India. After the
					...
					<p>
						...
						AAA Consumer Arbitration Rules governing the arbitration are
						...
						Any claims or disputes where the total amount of the award sought is
						...
						the Arbitration Rules. Any hearing will be held in a location within
						100 miles of your residence, unless you reside outside of the United
						States, and unless the parties agree otherwise. If you reside
						...
						in any court of competent jurisdiction. If the arbitrator grants you
						an award that is greater than the last settlement offer that the
					...
					<p>
						...
						a court and are subject to very limited review by a court. In the
