		...
		<FluidContainer>
			...
			<Container>
				...
				<Content generalPage={true}>
					...
					<p>
						Job Dundho follows a standard procedure of using log files. These
					...
					<p>
						Like any other website, Job Dundho uses 'cookies'. These cookies are
					...
					<p>
						...
						advertising partners of Job Dundho.
					</p>

					<p>
						Third-party ad servers or ad networks uses technologies like
						cookies, JavaScript, or Web Beacons that are used in their
						respective advertisements and links that appear on Job Dundho, which
					...
					<p>
						Note that Job Dundho has no access to or control over these cookies
					...
					<p>
						Job Dundho's Privacy Policy does not apply to other advertisers or
					...
					<p>
						Job Dundho does not knowingly collect any Personal Identifiable
